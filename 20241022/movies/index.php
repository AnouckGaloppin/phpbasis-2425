    ...
    <table>
      <thead>
        <tr>
          ...
          <th><a href="?sort=release_year&dir=<?= ($sort == 'release_year' && $direction == 'ASC' ? 'down' : "up") ?>">Titel</a></th>
          <th><a href="?sort=production_studio&dir=<?=($sort == 'production_studio' &&$direction == 'ASC ? 'down': 'up'); ?>">Productiehuis</a></th>
          <th>Genres</th>
        </tr>
      </thead>
      <tbody>
